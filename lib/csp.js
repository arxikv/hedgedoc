...
const defaultDirectives = {
  ...
  styleSrc: [config.serverURL + '/build/', config.serverURL + '/css/', '\'unsafe-inline\'', 'https://github.githubassets.com', 'https://fonts.googleapis.com'], // unsafe-inline is required for some libs, plus used in views
